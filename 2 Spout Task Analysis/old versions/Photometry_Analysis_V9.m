...
function  Photometry_Analysis_V9()
    ...
    for signal = 1:2
    close all
    to_analyze = {'left', 'right'}; %choose left, right, or both
    right_spout = 'water';
    left_spout = 'tastant';
    ...
    seconds_to_extend = 0;
    trials_to_check = 1:50; %List of trials (Don't worry for event alignment)
    fiber = 1; %Choose which fiber to look at
    %signal = 1; %set 1 for signal, 0 for control
    volume_to_check = 1000; %1000 if no variation 
    pre_ITI_length = 15;
    ...
    lick_window = 30; %Normally I used 4, but since your trials are long I extended it
    ...
    stim_time = 7; %What point into the trial does the US happen?
